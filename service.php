                        ...
                        <div class="tab-pane fade show active" id="tab-pane-1">
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-4">AutoCare Connect project aims to develop a comprehensive web-based application that facilitates efficient and transparent connections between vehicle owners and automotive service providers.</p>
            ...
            <div class="row gx-5">
                <div class="col-lg-6 py-5">
                    <div class="py-5">
                        ...
                        <p class="text-white mb-0"> Award winning car reapir service provider in the town. </p>
                    </div>
                </div>
                <div class="col-lg-6">
